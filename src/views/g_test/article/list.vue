    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="18">
          ...
          <a-col :md="8" :sm="24">
            <a-form-item label="描述" labelAlign="right" :labelCol="{span: 6}" :wrapperCol="{span: 18}" style="width: 100%;">
              <a-input v-model="queryParam.descrip" placeholder="" style="width: 100%;"/>
            </a-form-item>
          </a-col>
