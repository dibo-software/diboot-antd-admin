...
const generateRouterMap = [
  {
    path: '/g_demo',
    redirect: '/g_demo/customer/list',
    component: PageView,
    name: 'g_demo',
    meta: { title: '生成示例', icon: 'rocket', permission: ['g_demo'] },
    children: [

      {
        path: '/g_demo/customer/list',
        name: 'customerList',
        component: () => import('@/views/g_demo/customer/list'),
        meta: { title: '客户管理', keepAlive: true, permission: ['Customer'] }
      },

      {
        path: '/g_demo/contactPerson/list',
        name: 'contactPersonList',
        component: () => import('@/views/g_demo/contactPerson/list'),
        meta: { title: '联系人管理', keepAlive: true, permission: ['ContactPerson'] }
      },

      {
        path: '/g_demo/followupRecord/list',
        name: 'followupRecordList',
        component: () => import('@/views/g_demo/followupRecord/list'),
        meta: { title: '跟进记录查看', keepAlive: true, permission: ['FollowupRecord'] }
      },
      {
        path: '/g_demo/dealInfo/list',
        name: 'dealInfoList',
        component: () => import('@/views/g_demo/dealInfo/list'),
        meta: { title: '成交信息查看', keepAlive: true, permission: ['DealInfo'] }
      },
      {
        path: '/g_demo/salesLead/list',
        name: 'salesLeadList',
        component: () => import('@/views/g_demo/salesLead/list'),
        meta: { title: '销售线索管理', keepAlive: true, permission: ['SalesLead'] }
      },

      {
        path: '/g_demo/demoOne/list',
        name: 'demoOneList',
        component: () => import('@/views/g_demo/demoOne/list'),
        meta: { title: '销售线索分类', keepAlive: true, permission: ['DemoOne'] }
      }
